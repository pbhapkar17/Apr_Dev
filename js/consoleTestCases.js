...
console.log(fName + lName);//poonampatil
console.log(num,num2);//50 90
console.log(num + num2);//140
...
console.log(num > num2);//50>90--f
console.log(num2 > num);//t

// && -- logical AND operator LS T && RS T = T
// || -- logical OR operator  LS OR RS T = T
 
 console.log(num > num2 || num2 > num); // 50 > 90:F || 90 > 50:T
 console.log(num > num2 || num2 < num) ;//f

 console.log(num < num2 && num2 > num);//t
